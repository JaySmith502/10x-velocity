...
<tr><td>10xV Core</td><td>$2,000 / 4 weeks</td><td>Biweekly 90-minute session; dedicated strategist and architect; 10 hours of build time per cycle; documentation and handoff</td><td>Steady progress at a manageable cadence</td></tr>
<tr><td>10xV Growth</td><td>$4,000 / 4 weeks</td><td>Weekly 90-minute session; same team and inclusions; 20 hours of build time per cycle</td><td>Companies actively prioritizing AI that want weekly progress</td></tr>
<tr><td>10xV Pro</td><td>$8,000 / 4 weeks</td><td>Twice-weekly 90-minute sessions; 40 hours of build time per cycle</td><td>Moving across multiple departments at once</td></tr>
</tbody>
</table>
...
<p>Only one Louisville provider publishes prices, so here is that answer: a single 2-hour 10x Core Meeting with 10x Velocity is $999, and standing cadences run $2,000 per 4 weeks (biweekly), $4,000 (weekly), and $8,000 (twice weekly), with larger automation projects scoped and built inside the engagement. For every other local option, budget for a sales conversation before you get a number. MSP-delivered AI work is typically bundled into managed-services contracts; national consultancies price by proposal. Whatever you're quoted, apply the same test: is the price attached to a named workflow with a measurable baseline?</p>
