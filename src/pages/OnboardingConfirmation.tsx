        ...
        <section className="relative overflow-hidden py-20 md:py-28">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-velocity-muted mb-4">
              ...
              <div className="space-y-6">
                <div className="glass-card p-6">
                  <div className="flex items-start gap-4">
                    <div className="bg-velocity-accent/20 p-3 rounded-full flex-shrink-0">
                      <Phone className="w-6 h-6 text-velocity-accent" />
                    </div>
                    <div>
                      <h3 className="text-xl font-semibold text-velocity-light mb-2">Expect a Call</h3>
                ...
                <div className="glass-card p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-velocity-light mb-2">See What We've Built</h3>
                      <p className="text-velocity-muted">
                        While you wait, check out our{" "}
                        <Link to="/case-studies" className="text-velocity-accent hover:underline">
                          case studies
                        </Link>{" "}
