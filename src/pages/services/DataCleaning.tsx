    ...
    <>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="bg-surface border border-border rounded-lg p-8 mb-12 animate-fade-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Clean data ensures your analytics and AI models produce reliable insights.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-full bg-accent/20 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Clean data requires less pre-processing, speeding up your analytics pipeline.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-full bg-accent/20 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Avoid the expenses associated with decisions based on flawed data.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-full bg-accent/20 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Clean data leads to more informed, confident business decisions.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">Our Data Cleaning Process</h2>
          <div className="space-y-6">
            {process.map((step, index) => (
              <div key={step.title} className="bg-surface border border-border rounded-lg p-6 animate-fade-up" style={{ animationDelay: `${index * 0.1}s` }}>
