    ...
    <>
      ...
      <main className="flex-1">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            <a href="/case-studies" className="text-accent hover:underline flex items-center mb-4">
          ...
          <div className="bg-surface border border-border rounded-lg p-8 mb-10">
            ...
            <ul className="space-y-3 text-muted-foreground mb-6">
              <li className="flex items-start">
                <span className="text-accent mr-2 mt-1"><House className="w-5 h-5" /></span>
          ...
          <div className="bg-surface border border-border rounded-lg p-8 mb-10">
            <h2 className="text-2xl font-bold mb-4">The 10x Velocity Solution</h2>
            
            <div className="mb-6">
              <h3 className="text-xl font-bold mb-3">1. AI-Powered Lead Targeting & Qualification:</h3>
              <ul className="space-y-2 text-muted-foreground ml-6">
                <li className="flex items-start">
                  <span className="text-accent mr-2 mt-1"><BarChart className="w-4 h-4" /></span>
          ...
          <div className="bg-surface border border-border rounded-lg p-8 mb-10">
            ...
            <ul className="space-y-3 text-muted-foreground mb-6">
              <li className="flex items-start">
                <span className="text-accent mr-2 mt-1"><CheckIcon className="w-5 h-5" /></span>
          ...
          <div className="bg-surface border border-border rounded-lg p-8 mb-10">
            ...
            <p className="text-muted-foreground mb-6">
              Discover how our <Link to="/services/phone-voice-agents" className="text-accent hover:underline">AI voice agents</Link> and <Link to="/services" className="text-accent hover:underline">process automation services</Link> can transform your customer communication.
            </p>
