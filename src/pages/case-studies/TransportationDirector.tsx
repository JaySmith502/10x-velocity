        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-surface border border-border rounded-lg p-8 rounded-xl mb-12">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-muted-foreground">AI Builder form processing to extract key information from bills of lading</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                <span className="text-muted-foreground">Power Automate cloud flows to route documents based on shipment details</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                <span className="text-muted-foreground">Real-time notifications to dock teams via Teams and mobile alerts</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                <span className="text-muted-foreground">Central documentation repository for audit trails and quality control</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-surface border border-border rounded-lg p-8 rounded-xl">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                <span className="text-muted-foreground">Simple OCR solutions can solve complex logistical challenges with minimal disruption</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                <span className="text-muted-foreground">Power Automate's AI Builder components enable quick deployment without extensive AI expertise</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                <span className="text-muted-foreground">Automated document routing eliminates human error in high-volume, time-sensitive operations</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                <span className="text-muted-foreground">ROI is immediate when automation eliminates costly operational inefficiencies</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center bg-surface border border-border rounded-lg p-12 relative overflow-hidden">
          ...
          <p className="text-muted-foreground mb-8">
            See how our <Link to="/services" className="text-accent hover:underline">full suite of AI services</Link> can drive similar automation wins for your business.
          </p>
