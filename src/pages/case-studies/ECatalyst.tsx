      ...
      <main className="flex-1">
        ...
        <article className="container mx-auto px-4 py-20">
          ...
          <section className="mb-16">
            ...
            <p className="text-muted-foreground mb-6">
              Learn how our <Link to="/services" className="text-accent hover:underline">AI process automation services</Link> can streamline your workflows and accelerate growth.
            </p>
